...
namespace Modules\PageMetas\Providers;
...
class PageMetasServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = "PageMetas";

    protected string $nameLower = "pageMetas";
