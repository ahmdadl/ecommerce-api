...
class CompareListsServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = "CompareLists";

    protected string $nameLower = "compareLists";
    ...
    public function register(): void
    {
        ...
        /**
         * Initialize compareList service with current compareList or create a new one
         */
        $this->app->singleton(
            CompareListService::class,
            function (): ?CompareListService {
                ...
                $compareList =
                    $customer->compareList ??
                    CompareList::create([
                        "user_id" => $customer->id,
                    ]);
                return new CompareListService($compareList);
            }
        );
    }
